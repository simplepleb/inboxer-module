...
class CampaignController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->module_path = 'campaigns';

        // module icon
        $this->module_icon = 'fas fa-target';

        // module model name, path
        $this->module_model = "Modules\Inboxer\Entities\Campaign";
    }
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select('id','uid', 'name', 'subject', 'status', 'updated_at', 'customer_id', 'from_name', 'track_open', 'track_click');
        ...
        return Datatables::of($$module_name)
                        ->addColumn('action', function ($data) {
                            ...
                            return view('inboxer::backend.campaigns.includes.action_column', compact('module_name', 'data'));
                        })
