    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-4">
                <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                    <a href="{{ route("backend.lists.subscribers", $$module_name_singular->uid) }}" class="btn btn-success btn-sm ml-1" data-toggle="tooltip" title="Show Subscribers"><i class="fas fa-house-user"></i>&nbsp; Subscribers</a>
                    <a href="{{ route("backend.$module_name.show", $$module_name_singular->id) }}" class="btn btn-primary btn-sm ml-1" data-toggle="tooltip" title="Show Details"><i class="fas fa-eye"></i>&nbsp; Show</a>
                </div>
            </div>
            <!--/.col-->
        </div>
        ...
        <div class="row mt-4">
            <div class="col">
                ...
                @include ("inboxer::backend.$module_name.form")
