        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="float-right">
                    <x-buttons.create route='{{ route("backend.templates.build.select") }}' title="{{__('Create')}} {{ ucwords(Str::singular($module_name)) }}"/>
                    <a class="btn btn-primary" href="{{ route('backend.templates.upload') }}" ><i class="fa fa-upload"></i> </a>
