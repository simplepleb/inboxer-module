...
namespace Modules\Inboxer\Helpers;
...
class Utility
{
    ...
    {
        $result = self::dateTime($datetime)->format(trans('Y-m-d, H:i'));
    ...
    {
        return [
            ['value' => '1', 'text' => trans('marketing::messages.Monday')],
            ['value' => '2', 'text' => trans('marketing::messages.Tuesday')],
            ['value' => '3', 'text' => trans('marketing::messages.Wednesday')],
            ['value' => '4', 'text' => trans('marketing::messages.Thursday')],
            ['value' => '5', 'text' => trans('marketing::messages.Friday')],
            ['value' => '6', 'text' => trans('marketing::messages.Saturday')],
            ['value' => '7', 'text' => trans('marketing::messages.Sunday')],
        ];
    }
    ...
    {
        return [
            ['value' => '1', 'text' => trans('marketing::messages.January')],
            ['value' => '2', 'text' => trans('marketing::messages.February')],
            ['value' => '3', 'text' => trans('marketing::messages.March')],
            ['value' => '4', 'text' => trans('marketing::messages.April')],
            ['value' => '5', 'text' => trans('marketing::messages.May')],
            ['value' => '6', 'text' => trans('marketing::messages.June')],
            ['value' => '7', 'text' => trans('marketing::messages.July')],
            ['value' => '8', 'text' => trans('marketing::messages.August')],
            ['value' => '9', 'text' => trans('marketing::messages.September')],
            ['value' => '10', 'text' => trans('marketing::messages.October')],
            ['value' => '11', 'text' => trans('marketing::messages.November')],
            ['value' => '12', 'text' => trans('marketing::messages.December')],
        ];
    }
    ...
    {
        return [
            ['value' => '1', 'text' => trans('marketing::messages.1st_week')],
            ['value' => '2', 'text' => trans('marketing::messages.2nd_week')],
            ['value' => '3', 'text' => trans('marketing::messages.3rd_week')],
            ['value' => '4', 'text' => trans('marketing::messages.4th_week')],
            ['value' => '5', 'text' => trans('marketing::messages.5th_week')],
        ];
    }
    ...
    public static function dayStringFromTimestamp($timestamp)
    {
        if (isset($timestamp) && $timestamp != '0000-00-00 00:00:00') {
            ...
            $result = \Modules\Marketing\Library\Tool::dateTime($timestamp)->format('Y-m-d');
        } else {
            $result = \Modules\Marketing\Library\Tool::dateTime(\Carbon\Carbon::now())->format('Y-m-d');
        }
    ...
    public static function timeStringFromTimestamp($timestamp)
    {
        if (isset($timestamp) && $timestamp != '0000-00-00 00:00:00') {
            ...
            $result = \Modules\Marketing\Library\Tool::dateTime($timestamp)->format('H:i');
        } else {
            $result = \Modules\Marketing\Library\Tool::dateTime(\Carbon\Carbon::now())->format('H:i');
        }
    ...
    {
        return [
            ['value' => 'minute', 'text' => trans('marketing::messages.minute')],
            ['value' => 'hour', 'text' => trans('marketing::messages.hour')],
            ['value' => 'day', 'text' => trans('marketing::messages.day')],
            ['value' => 'week', 'text' => trans('marketing::messages.week')],
            ['value' => 'month', 'text' => trans('marketing::messages.month')],
            ['value' => 'year', 'text' => trans('marketing::messages.year')],
        ];
    }
    ...
    public static function phpPathsSelectOptions($paths)
    {
        ...
        $options[] = [
            'text' => trans('marketing::messages.php_bin_manual'),
            'value' => 'manual',
        ];
    ...
    public static function availableSystemBackgroundMethodSelectOptions()
    {
        $options = [
            [
                'text' => trans('marketing::messages.database_job_type'),
                'value' => 'database',
                'description' => trans('marketing::messages.database_job_type_desc'),
            ],
        ];

        if (true) {
            $options[] = [
                'text' => trans('marketing::messages.async_job_type'),
                'description' => trans('marketing::messages.async_job_type_desc'),
                'value' => 'async',
    ...
    public static function cronjobUpdateController($request, $controller)
    {
        ...
        $setting_php_bin_path = \Modules\Marketing\Entities\Setting::get('php_bin_path');
        ...
        if (empty(\Modules\Marketing\Entities\Setting::get('remote_job_token'))) {
            \Modules\Marketing\Entities\Setting::set('remote_job_token', str_random(60));
        }
        ...
        if ($request->isMethod('post')) {
            ...
            if ($request->queue_driver == 'database') {
                ...
                // Check valid path
                $check = \Modules\Marketing\Library\Tool::checkPHPBinPath($php_bin_path_value);
                if ($check != 'ok') {
                ...
                \Modules\Marketing\Entities\Setting::set('php_bin_path', $php_bin_path_value);
            ...
            if (in_array($queue_driver, ['database', 'async']) && config('queue.default') != $queue_driver) {
                \Modules\Marketing\Entities\Setting::setEnv('QUEUE_DRIVER', $queue_driver);
            }
            ...
            $request->session()->flash('alert-success', trans('marketing::messages.setting.updated'));
        }
    ...
    public static function format_number($number)
    {
        if (is_numeric($number) && floor($number) != $number) {
            return number_format($number, 2, trans('marketing::messages.dec_point'), trans('marketing::messages.thousands_sep'));
        } elseif (is_numeric($number)) {
            return number_format($number, 0, trans('marketing::messages.dec_point'), trans('marketing::messages.thousands_sep'));
        } else {
            return $number;
        }
    }
    ...
    {
        $result = !isset($datetime) ? '' : self::dateTime($datetime)->format(trans('marketing::messages.date_format'));
